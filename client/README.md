...
- `npm run app:build` — builds a double-clickable app at `src-tauri/target/release/bundle/macos/QuantamFS.app` (open it from Finder or Spotlight; ⌘Q quits).
...
- `public/fonts/`   Urbanist (self-hosted, OFL)
